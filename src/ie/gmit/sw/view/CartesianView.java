 ...
 * 
 */
//public class CartesianView extends GameView  { 
...
//	public CartesianView(ObjectSprite[][] matrix, ObjectSprite[][] things, Avatar player) throws Exception {
//		super(matrix, things, player);
